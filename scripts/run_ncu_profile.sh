...
#
# Usage:
#   bash scripts/run_ncu_profile.sh                    # all 8 datasets × 4 methods
#   bash scripts/run_ncu_profile.sh cant consph         # specific datasets
#
# Prerequisites:
#   - ncu (Nsight Compute CLI) in PATH
#   - Built BTC-TC + ToT + TRUST (bash scripts/build_all.sh)
...
DEFAULT_DATASETS="cant consph pwtk F1 eu-2005 Ga41As41H72 g7jac140sc wiki-Vote"
