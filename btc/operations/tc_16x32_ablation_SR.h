...
// Config SR: Shuffle for sparsity, Redux for final
__global__ void kernel_16x32_SR(
...
unsigned long long count_triangles_16x32_SR(btc::BCSR_16x32_Device& d_bcsr, float* kernel_ms = nullptr) {
    d_bcsr.reset_result();
    ...
    kernel_16x32_SR<<<blocks, threads>>>(d_bcsr.n, d_bcsr.n_row_blocks, d_bcsr.indptr, d_bcsr.indices, d_bcsr.blocks, d_bcsr.row_indices, d_bcsr.num_blocks, d_bcsr.result);
