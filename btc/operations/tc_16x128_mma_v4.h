...
// V4 kernel: Adaptive hybrid strategy for 16×128 blocks
// Based on v5's approach: dynamically choose MMA or CUDA Core based on sparsity
__global__ void kernel_16x128_mma_v4_adaptive(
...
unsigned long long count_triangles_16x128_v4(BCSR_16x128_Device& d_bcsr, float* kernel_ms = nullptr) {
    d_bcsr.reset_result();
    ...
    kernel_16x128_mma_v4_adaptive<<<num_blocks, threads_per_block>>>(
